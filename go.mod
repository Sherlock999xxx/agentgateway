...
require (
	...
	sigs.k8s.io/gateway-api-inference-extension/conformance v1.5.0-rc.2
...
require (
	...
	github.com/envoyproxy/go-control-plane/contrib v1.36.1-0.20260402053555-4e9843ddb8d0 // indirect
